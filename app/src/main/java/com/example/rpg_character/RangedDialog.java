...
public class RangedDialog extends Dialog implements View.OnClickListener {//create new ranged weapon Диалоговое окно добавления нового оружия(дальнего)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ranged_add_dialog);
