...
public class MeleeDialog extends Dialog implements View.OnClickListener {//create new melee weapon. Диалоговое окно добавления нового оружия
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.melee_add_dialog);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.meleeokbtn) {
            ...
            if (TextUtils.isEmpty(meleename.getText().toString())) {
                ...
                int bonus = CharacterActivity.mod(character.STR);
